<?php
	function cbo_faq() { 
		...
		array( 'labels' => array(
			'name' => __( 'Notre FAQ', 'bonestheme' ),
			'singular_name' => __( 'FAQ', 'bonestheme' ),
			'all_items' => __( 'Toutes la faq', 'bonestheme' ), 
		...
		'description' => __( 'Ceci est une faq d\'exemple', 'bonestheme' ),
		'public' => true,
	...
	register_taxonomy( 'faq_cat', 
		...
		array('hierarchical' => true,
			'labels' => array(
				'name' => __( 'Catégories de la FAQ', 'bonestheme' ),
